...
import com.fhx.propertyuser.fragment.repair.FinishFragment;
import com.fhx.propertyuser.fragment.repair.NoStartFragment;
import com.fhx.propertyuser.fragment.repair.UnderWayFragment;
...
public class RepairListActivity extends BaseActivity implements View.OnClickListener{
    ...
    protected void initData() {
        tvTitle.setText("维护报修");
        tv_title_right.setText("我要报修");
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.tv_title_right:
                CutToUtils.getInstance().JumpTo(RepairListActivity.this,ToRepairActivity.class);
                break;
        }
    }
}
